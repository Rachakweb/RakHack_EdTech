...
## Your Goal
In `snake.exe`, you need 50 points to win, and each "fruit" gives you 1 point.
**Task 1:** Modify the binary so that each fruit grants you 50 points, resulting in an instant win on your first fruit.
**Task 2 (Optional Hero Challenge):** Identify the code block where the program checks if the snake collided with itself, and disable it so you can never die.
